...
static struct msm_camera_i2c_reg_conf ov5640_start_settings[] = {
	{0x4202, 0x00},  /* Frame mask none */
	{0x3008, 0x02},  /* Sleep off */
};

static struct msm_camera_i2c_reg_conf ov5640_stop_settings[] = {
	{0x4202, 0x0F},  /* Frame mask with all*/
	{0x3008, 0x42},  /* Sleep mode on */
};

static struct msm_camera_i2c_reg_conf ov5640_1080p30_settings[] = {
	/* MIPI 2 Lane 1080P YUV 30 fps */
	{0x3103, 0x11},
	{0x3008, 0x82},
	{0x3008, 0x42},
	{0x3103, 0x03},
	...
	{0x3a1f, 0x14},
	{0x3008, 0x02},
	/* ov5640_1080p30_settings end */
};

static struct msm_camera_i2c_reg_conf ov5640_720p60_settings[] = {
	...
	{0x3a1f, 0x14},
	{0x3008, 0x02},
}; /* ov5640_720p_60_fps_settings end */

static struct msm_camera_i2c_reg_conf ov5640_5MP_15_settings[] = {
	/* MIPI 2lane 5M YUV 15fps */
	{0x3103, 0x11},
	{0x3008, 0x82},
	{0x3008, 0x42},
	{0x3103, 0x03},
	...
	{0x3a1f, 0x14},
	{0x3008, 0x02},
}; /* ov5640_5MP_15_settings end */

static struct msm_camera_i2c_reg_conf ov5640_VGA_90_settings[] = {
	{0x3103, 0x11},
	{0x3008, 0x82},
	{0x3008, 0x42},
	{0x3103, 0x03},
	...
	{0x3a1f, 0x14},
	{0x3008, 0x02},
}; /* ov5640_VGA_90_settings end */

struct ov5640_resolution_table_t {
	char *name;
...
static int32_t msm_ov5640_i2c_probe(struct i2c_client *client,
	const struct i2c_device_id *id)
{
	return msm_sensor_i2c_probe(client, id, &ov5640_s_ctrl);
}

static struct i2c_driver ov5640_i2c_driver = {
	.id_table = ov5640_i2c_id,
	.probe  = msm_ov5640_i2c_probe,
	.driver = {
...
static int __init ov5640_init_module(void)
{
	int32_t rc;
	pr_info("%s:%d\n", __func__, __LINE__);
...
static void __exit ov5640_exit_module(void)
{
	pr_info("%s:%d\n", __func__, __LINE__);
...
int32_t ov5640_sensor_config(struct msm_sensor_ctrl_t *s_ctrl,
	void __user *argp)
{
	...
	case CFG_SET_INIT_SETTING:
		...
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->
			...
			ov5640_1080p30_settings, /*ov5640_720p_60_fps_settings,*/
			ARRAY_SIZE(ov5640_1080p30_settings), /*ARRAY_SIZE(ov5640_720p_60_fps_settings),*/
	...
	case CFG_SET_RESOLUTION:
		...
		CDBG("CFG_SET_RESOLUTION - picking %s\n", ov5640_resolutions[res].name);
		CDBG(">>%s:%d<<\n", __func__, __LINE__);
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->
			i2c_write_conf_tbl(
			s_ctrl->sensor_i2c_client,
			ov5640_resolutions[res].settings,
			ov5640_resolutions[res].size,
			MSM_CAMERA_I2C_BYTE_DATA);
	...
	case CFG_SET_STOP_STREAM:
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->
			i2c_write_conf_tbl(
			s_ctrl->sensor_i2c_client,
			ov5640_stop_settings,
			ARRAY_SIZE(ov5640_stop_settings),
			MSM_CAMERA_I2C_BYTE_DATA);
	...
	case CFG_SET_START_STREAM:
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->
			i2c_write_conf_tbl(
			s_ctrl->sensor_i2c_client,
			ov5640_start_settings,
			ARRAY_SIZE(ov5640_start_settings),
			MSM_CAMERA_I2C_BYTE_DATA);
...
static struct msm_sensor_fn_t ov5640_func_tbl = {
	.sensor_config = ov5640_sensor_config,
...
static struct msm_sensor_ctrl_t ov5640_s_ctrl = {
	...
	.power_setting_array.power_setting = ov5640_power_setting,
	.power_setting_array.size = ARRAY_SIZE(ov5640_power_setting),
...
module_init(ov5640_init_module);
module_exit(ov5640_exit_module);
MODULE_AUTHOR("Harshesh Valera <hvalera@intrinsyc.com>");
MODULE_AUTHOR("James NG <JNg@intrinsyc.com>");
MODULE_DESCRIPTION("Omnivision OV5640 5MP YUV driver");
